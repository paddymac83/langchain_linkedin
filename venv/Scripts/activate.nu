...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mcnab\Documents\Python\LLM\langchain\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mcnab\Documents\Python\LLM\langchain\venv\Scripts\deactivate.nu'
